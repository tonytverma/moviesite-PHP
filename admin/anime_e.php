...
<div class="bg-dark">
  <div class="shell bg-dark">
    ...
    <ul>
                    ...
                    <li><a href="anime_e.php" class="active"><span>Animes</span></a></li>
    ...
    <form class="d-flex p-3" method="post" action="anime_e.php" role="search">
        ...
        <table class="table table-striped table-sm text-light">
          ...
          <tbody>
           ...
           while ($row = $animes->fetch_assoc()) { 
            ...
            <td><a href="anime_edit.php?anime_id=' . $row['anime_id'] . '">edit</a></td>
            <td><a href="episode_list.php?anime_name=' .str_replace(" ","",$row['anime_name']) . '">episodes</a></td>
          </tr>';
          }
           ?>
          </tbody>
