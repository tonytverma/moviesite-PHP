    ...
    <div class="container bg-dark  my-2 rounded-3">
        <div class="row">
            <div class="col align-self-start text-xl-center " style="padding-top: 10px;">
                <div class="card bg-secondary pb-10" style="width: 18rem;">
        ...
        <div class="row">
            <div class="col align-self-start text-xl-center " style="padding: 10px;">
                <button type="button" class="btn btn-outline-success bg-gradient d-inline w-auto" href="#"><a
                        href="{{createval.link}}"><b>360px download</b></a></button>
            </div>
        </div>
        <div class="row">
            <div class="col align-self-start text-xl-center " style="padding: 10px;">
                <button type="button" class="btn btn-outline-success bg-gradient d-inline w-auto" href="#"><a
                        href="{{createval.link}}"><b>480px download</b></a></button>
            </div>
        </div>
        <div class="row">
            <div class="col align-self-start text-xl-center " style="padding: 10px;">
                <button type="button" class="btn btn-outline-success bg-gradient d-inline w-auto" href="#"><a
                        href="{{createval.link}}"><b>720px download</b></a></button>
            </div>
        </div>
    </div>
